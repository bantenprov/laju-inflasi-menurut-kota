<template>
  <div class="card">
    <div class="card-header">
      <i class="fa fa-table" aria-hidden="true"></i> Laju Inflasi Kota
...
export default {
  ...
  methods: {
    createRow() {
      window.location = '#/admin/laju-inflasi-kota/create';
    },
    viewRow(rowData) {
      window.location = '#/admin/laju-inflasi-kota/' + rowData.id;
    },
    editRow(rowData) {
      window.location = '#/admin/laju-inflasi-kota/' + rowData.id + '/edit';
    },
    deleteRow(rowData) {
      let app = this;

      if (confirm('Do you really want to delete it?')) {
        axios.delete('/api/laju-inflasi-kota/' + rowData.id)
